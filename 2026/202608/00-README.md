...
| [MiniCPM-o 4.5 实时全双工全模态交互](./2026-MiniCPM-o4.5-实时全双工全模态交互/README.md) | 2026 | OpenBMB · arXiv | 9B 开源全模态模型，用 Omni-Flow（时分复用切窗+共享时间轴对齐 I/O）把回合制升级为实时全双工——边看边听边说且能主动；配 TAIL 治语音滞后、骨干只出文本外包语音给小解码器；<12GB 边缘可跑，VL 逼近 Gemini 2.5 Flash、全模态与语音生成超 Qwen3-Omni-30B | 已消化 | [总结.md](./2026-MiniCPM-o4.5-实时全双工全模态交互/总结.md) |
